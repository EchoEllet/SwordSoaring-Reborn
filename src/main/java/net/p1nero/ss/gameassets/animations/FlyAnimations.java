...
public class FlyAnimations {
    ...
    public static void buildFlyAnim(AnimationManager.AnimationBuilder builder) {
        ...
        APPRENTICE_FLYING = builder.nextAccessor("biped/fly_anim/fly_on_sword_apprentice_flying", accessor -> new StaticAnimation(0.5F, true, accessor, biped));

        APPRENTICE_SPEED_UP = builder.nextAccessor("biped/fly_anim/fly_on_sword_apprentice_acceleration", accessor -> new StaticAnimation(0.5F, true, accessor, biped));
        ...
        EXPERT_FLYING = builder.nextAccessor("biped/fly_anim/fly_on_sword_expert_flying", accessor ->  new StaticAnimation(0.5F, true, accessor, biped));

        EXPERT_SPEED_UP = builder.nextAccessor("biped/fly_anim/fly_on_sword_expert_acceleration", accessor ->  new StaticAnimation(0.5F, true, accessor, biped));
        ...
        MASTER_FLYING = builder.nextAccessor("biped/fly_anim/fly_on_sword_master_flying", accessor -> new StaticAnimation(0.5F, true, accessor, biped));

        MASTER_SPEED_UP = builder.nextAccessor("biped/fly_anim/fly_on_sword_master_acceleration", accessor ->  new StaticAnimation(0.5F, true, accessor, biped));
