...
public class WraithonAnimations {
    ...
    public static void buildWraithonAnim(AnimationManager.AnimationBuilder builder) {
        ...
        AttackAnimation.JointColliderPair[] atk = atkJoints.toArray(new AttackAnimation.JointColliderPair[0]);
        ...
        WRAITHON_1 = builder.nextAccessor("wraithon/wraithon_attack_1", (accessor -> new BasicAttackAnimation(0.15F, accessor, armature,
                new AttackAnimation.Phase(0.0F, 1, 1, 1.25F, 1.25F, Float.MAX_VALUE, false, InteractionHand.MAIN_HAND, atk),
                new AttackAnimation.Phase(1.25F, 2.16F, 2.16F, 2.42F, 2.42F, Float.MAX_VALUE, false, InteractionHand.MAIN_HAND, atk))
