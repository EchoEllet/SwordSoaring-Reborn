...
public class BabylonAnimations {
    ...
    public static void buildBabylonAnim() {
        ...
        BABYLON_SHOOT = new BabylonMultiPhaseAttackAnimation(0.15F, "babylon/babylon_shoot", babylonArmature, AnimationUtils.getPhases(babylonArmature.joints, 3.0F))
        ...
        BABYLON_SHOOT_L = new BabylonMultiPhaseAttackAnimation(0.15F, "babylon/babylon_shoot_l", babylonArmature, AnimationUtils.getPhases(babylonArmature.joints, 3.0F))
                .addEvents(AnimationProperty.StaticAnimationProperty.ON_END_EVENTS, AnimationEvent.create((livingEntityPatch, staticAnimation, objects) -> livingEntityPatch.getOriginal().discard(), AnimationEvent.Side.SERVER))
                .addProperty(AnimationProperty.StaticAnimationProperty.PLAY_SPEED_MODIFIER, (dynamicAnimation, livingEntityPatch, v, v1) -> 0.5F);
        BABYLON_SHOOT_R = new BabylonMultiPhaseAttackAnimation(0.15F, "babylon/babylon_shoot_r", babylonArmature, AnimationUtils.getPhases(babylonArmature.joints, 3.0F))
                .addEvents(AnimationProperty.StaticAnimationProperty.ON_END_EVENTS, AnimationEvent.create((livingEntityPatch, staticAnimation, objects) -> livingEntityPatch.getOriginal().discard(), AnimationEvent.Side.SERVER))
                .addProperty(AnimationProperty.StaticAnimationProperty.PLAY_SPEED_MODIFIER, (dynamicAnimation, livingEntityPatch, v, v1) -> 0.5F);
    }
