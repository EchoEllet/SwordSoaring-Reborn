...
public class ScreenSwordAnimations {
    ...
    public static AnimationEvent.InTimeEvent spawnDynamicHexagram(float time, Supplier<ParticleOptions> particleOptions, int count, Supplier<ScreenSwordArmature> armature) {
        return AnimationEvent.InTimeEvent.create(time, ((livingEntityPatch, staticAnimation, objects) -> {
            ParticleVFX.createLineBetweenJoint(livingEntityPatch, armature.get().W4, armature.get().W3, particleOptions.get(), count);
            ParticleVFX.createLineBetweenJoint(livingEntityPatch, armature.get().W3, armature.get().W5, particleOptions.get(), count);
            ParticleVFX.createLineBetweenJoint(livingEntityPatch, armature.get().W5, armature.get().W4, particleOptions.get(), count);
            ParticleVFX.createLineBetweenJoint(livingEntityPatch, armature.get().W1, armature.get().W2, particleOptions.get(), count);
            ParticleVFX.createLineBetweenJoint(livingEntityPatch, armature.get().W2, armature.get().W6, particleOptions.get(), count);
            ParticleVFX.createLineBetweenJoint(livingEntityPatch, armature.get().W6, armature.get().W1, particleOptions.get(), count);
        }), AnimationEvent.Side.CLIENT);
    }
