...
public class VatanseverStormAnimations {
    ...
    public static StaticAnimation VATANSEVER_STORM_RAIN;
    protected static void buildVatanseverStormAnim() {
        ...
        VATANSEVER_STORM_1 = new AutoDiscardAnimation(0.15F, "vatansever_storm/vatansever_storm_1_l", stormArmature,
        ...
        VATANSEVER_STORM_2 = new AutoDiscardAnimation(0.15F, "vatansever_storm/vatansever_storm_1_r", stormArmature,
                new AttackAnimation.Phase(0.0F, 0.0F, 10.0F, 10.0F, Float.MAX_VALUE, stormArmature.rootJoint, SwordSoaringColliders.VATANSEVER_STORM_PART));
        VATANSEVER_STORM_3 = new AutoDiscardAnimation(0.15F, "vatansever_storm/vatansever_storm_2_l", stormArmature,
                new AttackAnimation.Phase(0.0F, 0.0F, 10.0F, 10.0F, Float.MAX_VALUE, stormArmature.rootJoint, SwordSoaringColliders.VATANSEVER_STORM_PART));
        VATANSEVER_STORM_4 = new AutoDiscardAnimation(0.15F, "vatansever_storm/vatansever_storm_2_r", stormArmature,
                new AttackAnimation.Phase(0.0F, 0.0F, 10.0F, 10.0F, Float.MAX_VALUE, stormArmature.rootJoint, SwordSoaringColliders.VATANSEVER_STORM_PART));
        VATANSEVER_STORM_RAIN = new AutoDiscardAnimation(0.15F, "vatansever_storm/vatansever_swordgroup_rain", stormArmature,
                new AttackAnimation.Phase(0.0F, 0.0F, 5, 5, Float.MAX_VALUE, stormArmature.rootJoint, SwordSoaringColliders.VATANSEVER_STORM_PART));
    }
