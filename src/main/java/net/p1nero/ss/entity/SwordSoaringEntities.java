...
import net.p1nero.ss.entity.sword.ScreenSword;
...
public class SwordSoaringEntities {
    ...
    public static final RegistryObject<EntityType<ScreenSword>> SCREEN_SWORD = register("shield_sword",
            EntityType.Builder.of(ScreenSword::new, MobCategory.MISC));
