...
@OnlyIn(Dist.CLIENT)
public abstract class PatchedSwordRenderer<E extends AbstractSwordEntity, T extends LivingEntityPatch<E>, M extends EntityModel<E>, AM extends AnimatedMesh> extends PatchedLivingEntityRenderer<E, T, M, AM> {
