...
import net.p1nero.ss.entity.client.layer.PatchedRandomReplaceableLayer;
import net.p1nero.ss.entity.client.layer.ReplaceableRenderLayer;
import net.p1nero.ss.entity.sword.AbstractSwordEntity;
import net.p1nero.ss.entity.sword.client.PatchedSwordRenderer;
...
@OnlyIn(Dist.CLIENT)
public class PatchedBabylonRenderer<E extends AbstractSwordEntity, T extends LivingEntityPatch<E>, M extends EntityModel<E>> extends PatchedSwordRenderer<E, T, M, BabylonMesh> {
    @Override
    public void render(E entityIn, T entityPatch, LivingEntityRenderer<E, M> renderer, MultiBufferSource buffer, PoseStack poseStack, int packedLight, float partialTicks) {
        if(entityIn.getOwner() != null && !(entityIn.getItemStack(entityPatch).getItem() instanceof VatanseverItem)){
            this.addPatchedLayer(ReplaceableRenderLayer.class, new PatchedRandomReplaceableLayer());
    ...
    @Override
    public BabylonMesh getMesh(T t) {
