...
public class WraithonAttackAnimation extends AttackAnimation {
    ...
    protected void bindPhaseState(Phase phase) {
        ...
        this.stateSpectrumBlueprint
                ...
                .newTimePair(phase.start, phase.end).addState(EntityState.MOVEMENT_LOCKED, true).addState(EntityState.UPDATE_LIVING_MOTION, true).addState(EntityState.CAN_BASIC_ATTACK, false)
                .newTimePair(0, Float.MAX_VALUE).addState(EntityState.INACTION, true).addState(EntityState.TURNING_LOCKED, true)
